    ...
    usingOraclize
{
    ...
    */
    ...
    /**
    * @dev This variable is for the Ether that must be sent in order to cover the cost of using the
    * Oraclize service.
    */
    ...
    */
    uint256 public mintVerseGasLimit = 2000000;
    uint256 public updateBookNameGasLimit = 1000000;
    uint256 public updateNumberOfChaptersGasLimit = 1000000;
    uint256 public updateChapterVersesIGasLimit = 1000000;
    uint256 public updateChapterVersesIIGasLimit = 1000000;
    ...
    */
	...
	// Immediately after unhalting the contract check to see if the contract has enough funds
	// to be able to mint a verse itself.
    ...
    */
    function mint()
        ...
        public
    {
        require(msg.value == price || contractCanMint == true);
